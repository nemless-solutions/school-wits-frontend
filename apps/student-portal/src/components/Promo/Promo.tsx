    ...
    <section className="main-container py-16">
      <div className="grid grid-cols-2 gap-4 items-center">
        ...
        <div className="relative">
          <div className="absolute -top-4 -left-4 w-20 aspect-square bg-primary rounded-xl z-[-1]"></div>
          <div className="absolute -bottom-5 -right-5 w-24 aspect-square bg-secondary rounded-xl z-[-1]"></div>
          <iframe
